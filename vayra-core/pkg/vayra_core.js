 ...
 * @returns {any}
 */
export function applyTrust(streams, opts) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.applyTrust(retptr, addHeapObject(streams), addHeapObject(opts));
 ...
 * @returns {any}
 */
export function computeCorpusStats(streams, opts) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.computeCorpusStats(retptr, addHeapObject(streams), addHeapObject(opts));
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
        if (r2) {
...
export function parseStream(stream) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.parseStream(retptr, addHeapObject(stream));
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
        if (r2) {
 ...
 * @returns {any}
 */
export function parseStreams(streams) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.parseStreams(retptr, addHeapObject(streams));
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
        if (r2) {
 ...
 * @param {any} streams
 * @param {any} trust_opts
 * @param {any} score_opts
 * @returns {any}
 */
export function runPipelineParsed(streams, trust_opts, score_opts) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.runPipelineParsed(retptr, addHeapObject(streams), addHeapObject(trust_opts), addHeapObject(score_opts));
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
        if (r2) {
 ...
 * @returns {any}
 */
export function runPipelinePure(streams, trust_opts, score_opts) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.runPipelinePure(retptr, addHeapObject(streams), addHeapObject(trust_opts), addHeapObject(score_opts));
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
        if (r2) {
 ...
 * @returns {any}
 */
export function scoreStream(parsed, opts, corpus) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.scoreStream(retptr, addHeapObject(parsed), addHeapObject(opts), addHeapObject(corpus));
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
        if (r2) {
 ...
 * @returns {string}
 */
export function vayra_core_version() {
    let deferred1_0;
    let deferred1_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.vayra_core_version(retptr);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        deferred1_0 = r0;
        deferred1_1 = r1;
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('vayra_core_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
