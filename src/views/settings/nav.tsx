...
const SETTINGS_OPTIONS: SettingsOption[] = [
  ...
  { label: "Theme preset", section: "theme", anchorTitle: "Theme", keywords: ["theme", "color", "preset", "mineral monochrome", "titanium", "ivory", "graphite", "custom theme", "palette", "dark", "appearance"] },
  ...
  { label: "VAYRA identity (avatar / color)", section: "account", anchorTitle: "VAYRA identity", keywords: ["avatar", "profile photo", "upload photo", "color", "identity", "picture"] },
  { label: "VAYRA account (email / sign out)", section: "account", anchorTitle: "VAYRA account", keywords: ["vayra", "email", "sign out", "logout", "login", "account"] },
  { label: "Stremio integration", section: "account", anchorTitle: "Stremio integration", keywords: ["stremio", "connect", "import", "export", "library", "watch progress", "addons"] },
  ...
  { label: "Sign in or create a VAYRA account", section: "basics", keywords: ["sign in", "create", "login", "vayra account", "identity", "email"] },
  ...
  { label: "Reset to default avatar", section: "account", anchorTitle: "VAYRA identity", keywords: ["reset avatar", "default avatar", "remove photo", "revert", "reset to default"] },
  { label: "Your color", section: "account", anchorTitle: "VAYRA identity", keywords: ["color", "cursor color", "chat color", "name pill", "custom color", "hex picker", "swatch"] },
  { label: "Profiles (switch, add, edit)", section: "account", anchorTitle: "VAYRA identity", keywords: ["profiles", "profile", "who's watching", "whos watching", "who is watching", "switch profile", "add profile", "new profile", "edit profile", "manage profiles", "default profile", "kids profile", "child profile", "multiple profiles", "profile screen", "startup profile", "household"] },
  { label: "Sign in or create a VAYRA account", section: "account", anchorTitle: "VAYRA account", keywords: ["login", "sign in", "create", "vayra", "account", "email"] },
  { label: "Connect Stremio", section: "account", anchorTitle: "Stremio integration", keywords: ["stremio", "connect", "login", "optional integration"] },
  { label: "Re-authenticate Stremio", section: "account", anchorTitle: "Stremio integration", keywords: ["reauth", "refresh session", "stremio", "expired token", "re-login"] },
  { label: "Disconnect Stremio", section: "account", anchorTitle: "Stremio integration", keywords: ["logout", "disconnect", "stremio"] },
  { label: "Reveal Stremio email", section: "account", anchorTitle: "Stremio integration", keywords: ["show email", "hide email", "mask email", "privacy", "stremio id"] },
  ...
  { label: "Use my Trakt avatar as my VAYRA avatar", section: "trakt", keywords: ["trakt avatar", "profile picture", "avatar sync", "wear avatar"] },
  ...
  { label: "Use my AniList avatar as my VAYRA avatar", section: "anilist", keywords: ["anilist avatar", "profile picture", "avatar", "wear avatar"] },
  ...
  { label: "Use my Simkl avatar as my VAYRA avatar", section: "simkl", keywords: ["simkl avatar", "profile picture", "avatar", "wear avatar"] },
  ...
  { label: "Test relay connection", section: "relay", anchorTitle: "VAYRA Relay", keywords: ["test connection", "run test", "ping", "health", "reachable", "verify relay"] },
  { label: "Backup credentials", section: "relay", anchorTitle: "VAYRA Relay", keywords: ["export", "backup", "api token", "credentials", "json file", "cloudflare token"] },
  { label: "Stop relay", section: "relay", anchorTitle: "VAYRA Relay", keywords: ["stop", "delete worker", "remove relay", "teardown"] },
  { label: "Forget URL", section: "relay", anchorTitle: "VAYRA Relay", keywords: ["forget", "clear url", "reset relay", "remove url"] },
  { label: "Use a different URL", section: "relay", anchorTitle: "VAYRA Relay", keywords: ["change relay", "switch relay", "different url", "replace"] },
  { label: "Deploy mine instead", section: "relay", anchorTitle: "VAYRA Relay", keywords: ["own relay", "deploy mine", "self host", "migrate"] },
  { label: "Redeploy", section: "relay", anchorTitle: "VAYRA Relay", keywords: ["redeploy", "update relay", "upgrade", "new version", "redeploy instructions"] },
  { label: "Documentation: run your own relay", section: "relay", anchorTitle: "VAYRA Relay", keywords: ["docs", "documentation", "guide", "run your own", "instructions"] },
  ...
  { label: "VAYRA in your browser", section: "p2p", anchorTitle: "Your streaming server address", keywords: ["web ui", "browser app", "serve web", "phone", "tv browser", "11471", "web version"] },
  ...
  { label: "Embed mpv inside VAYRA window", section: "player", anchorTitle: "Player engine", keywords: ["embedded mpv", "separate window", "inline playback", "detached player", "external window"] },
  ...
  { label: "Bar color", section: "theme", anchorTitle: "Seek bar", keywords: ["seek bar color", "accent color", "recolor progress", "custom color", "VAYRA titanium", "mineral monochrome"] },
  ...
  { label: "Catch stremio:// install links inside VAYRA", section: "advanced", anchorTitle: "Stremio install links", keywords: ["protocol handler", "stremio link handler", "in app installer", "addon install", "default app", "configure and install"] },
  ...
  { label: "Get VAYRA for desktop", section: "advanced", keywords: ["download desktop app", "desktop version", "web limitations", "install harbor"] },
