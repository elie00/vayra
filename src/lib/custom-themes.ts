  ...
  return JSON.stringify(
    {
      ...
      bokeh: false,
      background: {
        image: "linear-gradient(180deg, #0a0b0d 0%, #18191c 100%)",
        dim: 0,
      },
      logo: {
        ...
        mark: "data:image/svg+xml;base64,PHN2ZyB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciIHZpZXdCb3g9IjAgMCAyNCAyNCI+PGNpcmNsZSBjeD0iMTIiIGN5PSIxMiIgcj0iMTAiIGZpbGw9IiNhOGFhYWQiLz48L3N2Zz4=",
      },
      css: "/* Optional: extra CSS layered on top. Targets work like a regular stylesheet. */\n.harbor-cinema-badge { color: #a8aaad; border-color: rgba(168,170,173,0.35); }",
