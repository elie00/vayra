...
export const CURATED_ADDONS: CuratedEntry[] = [
  ...
  },
  {
    ...
    category: "metadata",
    tags: ["free", "configurable"],
    curatorNote: "Pulls metadata from TMDB, TVDB, TVMaze, MAL, IMDb, Fanart.tv. Pick which source wins per type. VAYRA's TMDB key gives you most of this natively.",
    rails: ["metadata"],
    recommended: 84,
  },
  {
    ...
    category: "metadata",
    tags: ["free", "configurable"],
    curatorNote: "TMDB catalogs as a Stremio addon: Trending, In Theaters, by Genre. Useful if you don't want to hand VAYRA your TMDB key.",
    rails: ["metadata"],
    recommended: 82,
  },
  {
  ...
  },
  {
    ...
    category: "metadata",
    tags: ["free"],
    curatorNote: "Per-service catalogs (Netflix, Disney+, HBO Max, Prime, Apple TV+). What's streaming where, by region. VAYRA already does this with a TMDB key.",
    rails: ["metadata"],
    recommended: 78,
  },
  {
