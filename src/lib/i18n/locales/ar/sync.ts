const sync: Record<string, string> = {
  ...
  "Show your AniList lists as rails on the Anime page, keep your watch progress in sync as you finish episodes, and use your AniList avatar as your VAYRA photo. Free at anilist.co.": "اعرض قوائم AniList الخاصة بك كصفوف في صفحة الأنمي، واحتفظ بمزامنة تقدم المشاهدة عند إكمالك للحلقات، واستخدم صورتك الشخصية على AniList كصورة في VAYRA. مجانًا على anilist.co.",
  "Connect AniList": "ربط AniList",
  "About AniList": "حول AniList",
  "Connected": "متصل",
  "VAYRA shows your AniList lists on the Anime page and keeps your progress in sync.": "يعرض VAYRA قوائم AniList الخاصة بك في صفحة الأنمي ويُبقي تقدمك متزامنًا.",
  "Authorized": "مُصرّح",
  ...
  "Use my AniList avatar as my VAYRA avatar": "استخدام صورتي في AniList كصورتي في VAYRA",
  "Show your AniList profile picture as your VAYRA avatar.": "عرض صورتك الشخصية على AniList كصورتك في VAYRA.",
  ...
  "VAYRA will mark what you finish as watched on Simkl and sync your plan-to-watch list.": "سيقوم VAYRA بتعليم ما تكمله كمُشاهَد في Simkl ومزامنة قائمة \"أنوي مشاهدتها\" الخاصة بك.",
  "Authorized on this device": "مُصرّح على هذا الجهاز",
  "Use my Simkl avatar as my VAYRA avatar": "استخدام صورتي في Simkl كصورتي في VAYRA",
  "Wear your Simkl profile picture across VAYRA instead of the default.": "استخدم صورتك الشخصية على Simkl عبر VAYRA بدلًا من الصورة الافتراضية.",
