...
export function StreamCheckPill({
  ...
  const copy = live
    ? variant === "check"
      ...
      : variant === "stalled"
        ? { title: t("Channel is taking a while"), sub: t("This source is slow. Try another."), icon: AlertCircle, accent: "#a8aaad" }
    ...
    : variant === "check"
      ...
      : variant === "stalled"
        ? { title: t("Stream is taking a while"), sub: t("Probably not cached. Pick another?"), icon: AlertCircle, accent: "#a8aaad" }
