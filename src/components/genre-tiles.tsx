...
const GENRE_PALETTE: Record<string, { from: string; to: string; ink: string }> = {
  ...
  Comedy: { from: "oklch(0.55 0.16 295)", to: "oklch(0.22 0.08 280)", ink: "oklch(0.96 0.02 300)" },
  Crime: { from: "oklch(0.32 0.10 250)", to: "oklch(0.14 0.04 235)", ink: "oklch(0.95 0.04 250)" },
  ...
  History: { from: "oklch(0.42 0.10 275)", to: "oklch(0.16 0.05 260)", ink: "oklch(0.95 0.04 280)" },
  ...
  Mystery: { from: "oklch(0.32 0.10 215)", to: "oklch(0.14 0.06 230)", ink: "oklch(0.95 0.04 210)" },
  ...
  War: { from: "oklch(0.32 0.06 255)", to: "oklch(0.14 0.04 245)", ink: "oklch(0.95 0.02 255)" },
  Western: { from: "oklch(0.45 0.12 315)", to: "oklch(0.18 0.08 300)", ink: "oklch(0.96 0.04 315)" },
};
